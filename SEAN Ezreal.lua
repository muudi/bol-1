...
function ScriptMsg(msg)
  print("<font color=\"#daa520\"><b>SEAN Ezreal:</b></font> <font color=\"#FFFFFF\">"..msg.."</font>")
end
...
local ServerPath = "/seanlol/BoL/master/Server.status".."?rand="..math.random(1,10000)
...
print("<font color=\"#daa520\"><b>SEAN Ezreal:</b> </font><font color=\"#FFFFFF\">Server status: </font><font color=\"#ff0000\"><b>"..Server.."</b></font>")
...
local ScriptPath = "/seanlol/BoL/master/SEAN Ezreal.lua".."?rand="..math.random(1,10000)
local UpdateURL = "https://"..Host..ScriptPath

local VersionPath = "/seanlol/BoL/master/SEAN/SEAN Ezreal.version".."?rand="..math.random(1,10000)
...
function EzrealMenu()
  ...
  Menu = scriptConfig("SEAN Ezreal", "SEAN Ezreal")
  
  Menu:addSubMenu("적중률설정", "HitChance")
  
    Menu.HitChance:addSubMenu("스킬콤보적중률", "Combo")
      Menu.HitChance.Combo:addParam("Q", "신비한화살(Q)적중률 (기본값 = 1)", SCRIPT_PARAM_SLICE, 1, 1, 3, 2)
      Menu.HitChance.Combo:addParam("W", "정수의흐름(W)적중률 (기본값 = 1.2)", SCRIPT_PARAM_SLICE, 1.2, 1, 3, 2)
      Menu.HitChance.Combo:addParam("R", "정조준일격(R) 적중률 (기본값 = 0.01)", SCRIPT_PARAM_SLICE, .01, .01, 3, 2)
      
    Menu.HitChance:addSubMenu("견제스킬적중률", "Harass")
      Menu.HitChance.Harass:addParam("Q", "신비한화살(Q)적중률 (기본값 = 1.4)", SCRIPT_PARAM_SLICE, 1.4, 1, 3, 2)
      Menu.HitChance.Harass:addParam("W", "정수의흐름(W)적중률 (기본값 = 1.4)", SCRIPT_PARAM_SLICE, 1.4, 1, 3, 2)
      
  Menu:addSubMenu("스킬콤보설정", "Combo")
    Menu.Combo:addParam("On", "스킬콤보사용", SCRIPT_PARAM_ONKEYDOWN, false, 32)
      Menu.Combo:addParam("Blank", "", SCRIPT_PARAM_INFO, "")
    Menu.Combo:addParam("Q", "신비한화살(Q)사용", SCRIPT_PARAM_ONOFF, true)
    Menu.Combo:addParam("Info", "신비한화살(Q) 최소마나설정 > x%", SCRIPT_PARAM_INFO, "")
    Menu.Combo:addParam("Q2", "기본값 = 0", SCRIPT_PARAM_SLICE, 0, 0, 100, 0)
      Menu.Combo:addParam("Blank", "", SCRIPT_PARAM_INFO, "")
    Menu.Combo:addParam("W", "정수의흐름(W)", SCRIPT_PARAM_ONOFF, true)
    Menu.Combo:addParam("Info", "정수의흐름(W) 최소마나설정 > x%", SCRIPT_PARAM_INFO, "")
    Menu.Combo:addParam("W2", "기본값 = 30", SCRIPT_PARAM_SLICE, 30, 0, 100, 0)
      Menu.Combo:addParam("Blank", "", SCRIPT_PARAM_INFO, "")
    Menu.Combo:addParam("R", "정조준일격(R) (1인궁)", SCRIPT_PARAM_ONOFF, true)
      Menu.Combo:addParam("Blank", "", SCRIPT_PARAM_INFO, "")
    Menu.Combo:addParam("R2", "정조준일격(R) (다인궁)", SCRIPT_PARAM_ONOFF, true)
    Menu.Combo:addParam("R3", "정조준일격(R) 최소인원", SCRIPT_PARAM_SLICE, 4, 2, 5, 0)
      Menu.Combo:addParam("Blank", "", SCRIPT_PARAM_INFO, "")
    Menu.Combo:addParam("Item", "아이템사용", SCRIPT_PARAM_ONOFF, true)
      Menu.Combo:addParam("BRK", "체력비례 몰왕검사용 < x%", SCRIPT_PARAM_SLICE, 40, 0, 100, 0)
    
  Menu:addSubMenu("클리어설정", "Clear")
  
    Menu.Clear:addSubMenu("라인클리어설정", "Farm")
      Menu.Clear.Farm:addParam("On", "라인클리어", SCRIPT_PARAM_ONKEYDOWN, false, GetKey('V'))
        Menu.Clear.Farm:addParam("Blank", "", SCRIPT_PARAM_INFO, "")
      Menu.Clear.Farm:addParam("Q", "신비한화살(Q)사용", SCRIPT_PARAM_ONOFF, true)
      Menu.Clear.Farm:addParam("Info", "신비한화살(Q) 최소마나설정 > x%", SCRIPT_PARAM_INFO, "")
      Menu.Clear.Farm:addParam("Q2", "기본값 = 70", SCRIPT_PARAM_SLICE, 70, 0, 100, 0)
        
    Menu.Clear:addSubMenu("정글클리어설정", "JFarm")
      Menu.Clear.JFarm:addParam("On", "정글클리어", SCRIPT_PARAM_ONKEYDOWN, false, GetKey('V'))
        Menu.Clear.JFarm:addParam("Blank", "", SCRIPT_PARAM_INFO, "")
      Menu.Clear.JFarm:addParam("Q", "신비한화살(Q)사용", SCRIPT_PARAM_ONOFF, true)
      Menu.Clear.JFarm:addParam("Info", "신비한화살(Q) 최소마나설정 > x%", SCRIPT_PARAM_INFO, "")
      Menu.Clear.JFarm:addParam("Q2", "기본값 = 0", SCRIPT_PARAM_SLICE, 0, 0, 100, 0)
      
  Menu:addSubMenu("스킬견제설정", "Harass")
    Menu.Harass:addParam("On", "스킬견제사용", SCRIPT_PARAM_ONKEYDOWN, false, GetKey('C'))
    Menu.Harass:addParam("On2", "버튼식ON/OFF", SCRIPT_PARAM_ONKEYTOGGLE, false, GetKey('T'))
      Menu.Harass:addParam("Blank", "", SCRIPT_PARAM_INFO, "")
    Menu.Harass:addParam("Q", "신비한화살(Q)사용", SCRIPT_PARAM_ONOFF, true)
    Menu.Harass:addParam("Info", "신비한화살(Q) 최소마나설정 > x%", SCRIPT_PARAM_INFO, "")
    Menu.Harass:addParam("Q2", "기본값 = 0", SCRIPT_PARAM_SLICE, 0, 0, 100, 0)
      Menu.Harass:addParam("Blank", "", SCRIPT_PARAM_INFO, "")
    Menu.Harass:addParam("W", "정수의흐름(W)", SCRIPT_PARAM_ONOFF, true)
    Menu.Harass:addParam("Info", "정수의흐름(W) 최소마나설정 > x%", SCRIPT_PARAM_INFO, "")
    Menu.Harass:addParam("W2", "기본값 = 40", SCRIPT_PARAM_SLICE, 40, 0, 100, 0)
    
  Menu:addSubMenu("막타모드설정", "LastHit")
    Menu.LastHit:addParam("On", "막타설정", SCRIPT_PARAM_ONKEYDOWN, false, GetKey('X'))
      Menu.LastHit:addParam("Blank", "", SCRIPT_PARAM_INFO, "")
    Menu.LastHit:addParam("Q", "신비한화살(Q)사용", SCRIPT_PARAM_ONOFF, false)
    Menu.LastHit:addParam("Info", "신비한화살(Q) 최소마나설정 > x%", SCRIPT_PARAM_INFO, "")
    Menu.LastHit:addParam("Q2", "기본값 = 75", SCRIPT_PARAM_SLICE, 75, 0, 100, 0)
    
  Menu:addSubMenu("정글스틸설정", "JSteal")
    Menu.JSteal:addParam("On", "정글스틸사용", SCRIPT_PARAM_ONKEYDOWN, false, GetKey('X'))
      Menu.JSteal:addParam("Blank", "", SCRIPT_PARAM_INFO, "")
    Menu.JSteal:addParam("Q", "신비한화살(Q)사용", SCRIPT_PARAM_ONOFF, true)
    if Smite ~= nil then
      Menu.JSteal:addParam("Blank", "", SCRIPT_PARAM_INFO, "")
    Menu.JSteal:addParam("S", "강타(Smite)사용", SCRIPT_PARAM_ONOFF, true)
      Menu.JSteal:addParam("Blank", "", SCRIPT_PARAM_INFO, "")
  ...
  Menu:addSubMenu("킬스틸설정", "KillSteal")
    Menu.KillSteal:addParam("On", "킬스틸사용", SCRIPT_PARAM_ONOFF, true)
      Menu.KillSteal:addParam("Blank", "", SCRIPT_PARAM_INFO, "")
    Menu.KillSteal:addParam("Q", "신비한화살(Q)사용", SCRIPT_PARAM_ONOFF, true)
      Menu.KillSteal:addParam("Blank", "", SCRIPT_PARAM_INFO, "")
    Menu.KillSteal:addParam("W", "정수의흐름(W)사용", SCRIPT_PARAM_ONOFF, true)
    if Ignite ~= nil then
      Menu.KillSteal:addParam("Blank", "", SCRIPT_PARAM_INFO, "")
  ...
  Menu:addSubMenu("도주옵션설정", "Flee")
    Menu.Flee:addParam("On", "도주모드사용", SCRIPT_PARAM_ONKEYDOWN, false, GetKey('G'))
    
  Menu:addSubMenu("기타세부설정", "Misc")
    if VIP_USER then
    Menu.Misc:addParam("UsePacket", "패킷사용", SCRIPT_PARAM_ONOFF, true)
    end
  ...
  Menu:addSubMenu("스킬범위설정", "Draw")
  
    Menu.Draw:addSubMenu("Draw Target", "Target")
      Menu.Draw.Target:addParam("Q", "신비한화살(Q)타겟", SCRIPT_PARAM_ONOFF, true)
      Menu.Draw.Target:addParam("W", "정수의흐름(W)타겟", SCRIPT_PARAM_ONOFF, false)
      Menu.Draw.Target:addParam("R", "정조준일격(R)타겟", SCRIPT_PARAM_ONOFF, false)
    ...
    Menu.Draw:addParam("On", "전체범위사용", SCRIPT_PARAM_ONOFF, true)
      Menu.Draw:addParam("Blank", "", SCRIPT_PARAM_INFO, "")
    Menu.Draw:addParam("AA", "Draw Attack range", SCRIPT_PARAM_ONOFF, true)
    Menu.Draw:addParam("Q", "신비한화살(Q)범위", SCRIPT_PARAM_ONOFF, true)
    Menu.Draw:addParam("W", "정수의흐름(W)범위", SCRIPT_PARAM_ONOFF, false)
    Menu.Draw:addParam("E", "비전이동(E)범위", SCRIPT_PARAM_ONOFF, false)
    if Ignite ~= nil then
      Menu.Draw:addParam("Blank", "", SCRIPT_PARAM_INFO, "")
    Menu.Draw:addParam("I", "점화(Ignite)범위", SCRIPT_PARAM_ONOFF, false)
    end
    if Smite ~= nil then
      Menu.Draw:addParam("Blank", "", SCRIPT_PARAM_INFO, "")
    Menu.Draw:addParam("S", "강타(Smite)범위", SCRIPT_PARAM_ONOFF, true)
    end
      Menu.Draw:addParam("Blank", "", SCRIPT_PARAM_INFO, "")
    Menu.Draw:addParam("Path", "이동경로표시", SCRIPT_PARAM_ONOFF, false)
      Menu.Draw:addParam("Blank", "", SCRIPT_PARAM_INFO, "")
    Menu.Draw:addParam("Hitchance", "히트찬스표시", SCRIPT_PARAM_ONOFF, true)
