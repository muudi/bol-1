...
print("<font color=\"#daa520\"><b>SEAN Corki:</b> </font><font color=\"#FFFFFF\">Server status: </font><font color=\"#ff0000\"><b>"..Server.."</b></font>")
...
local ScriptPath = "/seanlol/BoL/master/SEAN Corki.lua".."?rand="..math.random(1,10000)
local UpdateURL = "https://"..Host..ScriptPath

local VersionPath = "/seanlol/BoL/master/SEAN Corki.version".."?rand="..math.random(1,10000)
...
function CorkiMenu()
  ...
  Menu = scriptConfig("SEAN Corki", "SEAN Corki")

  Menu:addSubMenu("적중률설정", "HitChance")
  
    Menu.HitChance:addSubMenu("스킬콤보 적중률", "Combo")
      Menu.HitChance.Combo:addParam("Q", "인광탄(Q) 적중률 (Default value = 1)", SCRIPT_PARAM_SLICE, 1, 1, 3, 2)
      Menu.HitChance.Combo:addParam("R", "미사일폭격(R) 적중률 (Default value = 0.12)", SCRIPT_PARAM_SLICE, .12, 0.01, 3, 2)
      
    Menu.HitChance:addSubMenu("스킬견제 적중률", "Harass")
      Menu.HitChance.Harass:addParam("Q", "인광탄(Q) 적중률 (Default value = 2)", SCRIPT_PARAM_SLICE, 2, 1, 3, 2)
      Menu.HitChance.Harass:addParam("R", "미사일폭격(R) 적중률 (Default value = 3)", SCRIPT_PARAM_SLICE, 3, 1, 3, 2)
  ...
  Menu:addSubMenu("스킬콤보설정", "Combo")
    ...
    Menu.Combo:addParam("Q", "인광탄(Q)사용", SCRIPT_PARAM_ONOFF, true)
    Menu.Combo:addParam("Info", "인광탄(Q) 마나 > x%사용", SCRIPT_PARAM_INFO, "")
    Menu.Combo:addParam("Q2", "적중률 기본값 = 0", SCRIPT_PARAM_SLICE, 0, 0, 100, 0)
      Menu.Combo:addParam("Blank", "", SCRIPT_PARAM_INFO, "")
    Menu.Combo:addParam("R", "미사일폭격(R)", SCRIPT_PARAM_ONOFF, true)
    Menu.Combo:addParam("Info", "미사일폭격(R)마나 > x%사용", SCRIPT_PARAM_INFO, "")
    Menu.Combo:addParam("R2", "적중률 기본값 = 0", SCRIPT_PARAM_SLICE, 0, 0, 100, 0)
      Menu.Combo:addParam("Blank", "", SCRIPT_PARAM_INFO, "")
    Menu.Combo:addParam("Item", "몰왕검(BRK) 사용", SCRIPT_PARAM_ONOFF, true)
      Menu.Combo:addParam("BRK", "내 체력 < x% 몰왕검(BRK)사용", SCRIPT_PARAM_SLICE, 40, 0, 100, 0)
    
  Menu:addSubMenu("라인클리어설정", "Clear")
  
    Menu.Clear:addSubMenu("라인클리어", "Farm")
      Menu.Clear.Farm:addParam("On", "라인클리어사용", SCRIPT_PARAM_ONKEYDOWN, false, GetKey('V'))
        Menu.Clear.Farm:addParam("Blank", "", SCRIPT_PARAM_INFO, "")
      Menu.Clear.Farm:addParam("Q", "인광탄(Q)사용", SCRIPT_PARAM_ONOFF, true)
      Menu.Clear.Farm:addParam("Info", "인광탄(Q) 마나 > x%사용", SCRIPT_PARAM_INFO, "")
      Menu.Clear.Farm:addParam("Q2", "마나%기본값 = 70", SCRIPT_PARAM_SLICE, 70, 0, 100, 0)
        Menu.Clear.Farm:addParam("Blank", "", SCRIPT_PARAM_INFO, "")
      Menu.Clear.Farm:addParam("R", "미사일폭격(R)사용", SCRIPT_PARAM_ONOFF, true)
      Menu.Clear.Farm:addParam("Info", "미사일폭격(R) 마나 > x%사용", SCRIPT_PARAM_INFO, "")
      Menu.Clear.Farm:addParam("R2", "마나%기본값 = 70", SCRIPT_PARAM_SLICE, 70, 0, 100, 0)
        
    Menu.Clear:addSubMenu("정글클리어", "JFarm")
      Menu.Clear.JFarm:addParam("On", "정글클리어사용", SCRIPT_PARAM_ONKEYDOWN, false, GetKey('V'))
        Menu.Clear.JFarm:addParam("Blank", "", SCRIPT_PARAM_INFO, "")
      Menu.Clear.JFarm:addParam("Q", "인광탄(Q)사용", SCRIPT_PARAM_ONOFF, true)
      Menu.Clear.JFarm:addParam("Info", "인광탄(Q) 마나 > x%사용", SCRIPT_PARAM_INFO, "")
      Menu.Clear.JFarm:addParam("Q2", "마나%기본값 = 0", SCRIPT_PARAM_SLICE, 0, 0, 100, 0)
        Menu.Clear.JFarm:addParam("Blank", "", SCRIPT_PARAM_INFO, "")
      Menu.Clear.JFarm:addParam("R", "미사일폭격(R)사용", SCRIPT_PARAM_ONOFF, true)
      Menu.Clear.JFarm:addParam("Info", "미사일폭격(R) 마나 > x%사용", SCRIPT_PARAM_INFO, "")
      Menu.Clear.JFarm:addParam("R2", "마나%기본값 = 0", SCRIPT_PARAM_SLICE, 0, 0, 100, 0)
  ...
  Menu:addSubMenu("스킬견제설정", "Harass")
    ...
    Menu.Harass:addParam("Q", "인광탄(Q)사용", SCRIPT_PARAM_ONOFF, true)
    Menu.Harass:addParam("Info", "인광탄(Q) 마나 > x%사용", SCRIPT_PARAM_INFO, "")
    Menu.Harass:addParam("Q2", "Default value = 0", SCRIPT_PARAM_SLICE, 0, 0, 100, 0)
      Menu.Harass:addParam("Blank", "", SCRIPT_PARAM_INFO, "")
    Menu.Harass:addParam("R", "Use R", SCRIPT_PARAM_ONOFF, true)
    Menu.Harass:addParam("Info", "미사일폭격(R) 마나 > x%사용", SCRIPT_PARAM_INFO, "")
    Menu.Harass:addParam("R2", "Default value = 0", SCRIPT_PARAM_SLICE, 0, 0, 100, 0)
    
  Menu:addSubMenu("막타모드설정", "LastHit")
    Menu.LastHit:addParam("On", "막타모드사용", SCRIPT_PARAM_ONKEYDOWN, false, GetKey('X'))
      Menu.LastHit:addParam("Blank", "", SCRIPT_PARAM_INFO, "")
    Menu.LastHit:addParam("Q", "인광탄(Q)사용", SCRIPT_PARAM_ONOFF, false)
    Menu.LastHit:addParam("Info", "인광탄(Q) 마나 > x%사용", SCRIPT_PARAM_INFO, "")
    Menu.LastHit:addParam("Q2", "마나%기본값 = 90", SCRIPT_PARAM_SLICE, 90, 0, 100, 0)
    Menu.LastHit:addParam("R", "미사일폭격(R)사용", SCRIPT_PARAM_ONOFF, true)
    Menu.LastHit:addParam("Info", "미사일폭격(R) 마나 > x%사용", SCRIPT_PARAM_INFO, "")
    Menu.LastHit:addParam("R2", "마나%기본값 = 80", SCRIPT_PARAM_SLICE, 80, 0, 100, 0)
    
  Menu:addSubMenu("정글스틸설정", "JSteal")
    Menu.JSteal:addParam("On", "정글몹스틸사용", SCRIPT_PARAM_ONKEYDOWN, false, GetKey('X'))
      Menu.JSteal:addParam("Blank", "", SCRIPT_PARAM_INFO, "")
    Menu.JSteal:addParam("Q", "인광탄(Q)사용", SCRIPT_PARAM_ONOFF, true)
    Menu.JSteal:addParam("R", "미사일폭격(R)사용", SCRIPT_PARAM_ONOFF, true)
    if Smite ~= nil then
      Menu.JSteal:addParam("Blank", "", SCRIPT_PARAM_INFO, "")
    Menu.JSteal:addParam("S", "강타(Smite)사용", SCRIPT_PARAM_ONOFF, true)
    end
      Menu.JSteal:addParam("Blank", "", SCRIPT_PARAM_INFO, "")
    Menu.JSteal:addParam("Always", "인광탄(Q)사용, 미사일폭격(R), 강타\n(바론 & 드래곤)", SCRIPT_PARAM_ONOFF, true)
  ...
  Menu:addSubMenu("킬스틸설정", "KillSteal")
    ...
    Menu.KillSteal:addParam("Q", "인광탄(Q)사용", SCRIPT_PARAM_ONOFF, true)
      Menu.KillSteal:addParam("Blank", "", SCRIPT_PARAM_INFO, "")
    Menu.KillSteal:addParam("R", "미사일폭격(R)사용", SCRIPT_PARAM_ONOFF, true)
    if Ignite ~= nil then
      Menu.KillSteal:addParam("Blank3", "", SCRIPT_PARAM_INFO, "")
    Menu.KillSteal:addParam("I", "점화(Ignite)사용", SCRIPT_PARAM_ONOFF, true)
    end
    if Smite ~= nil then
      Menu.KillSteal:addParam("Blank4", "", SCRIPT_PARAM_INFO, "")
    Menu.KillSteal:addParam("S", "추적자의검 사용", SCRIPT_PARAM_ONOFF, true)
    end
  ...
  Menu:addSubMenu("사거리표시", "Draw")
  
    Menu.Draw:addSubMenu("스킬범위설정", "Target")
      Menu.Draw.Target:addParam("Q", "인광탄(Q)타겟설정", SCRIPT_PARAM_ONOFF, true)
      Menu.Draw.Target:addParam("R", "미사일폭격(R)타겟설정", SCRIPT_PARAM_ONOFF, false)
    ...
    Menu.Draw:addParam("On", "모든범위설정", SCRIPT_PARAM_ONOFF, true)
      Menu.Draw:addParam("Blank", "", SCRIPT_PARAM_INFO, "")
    Menu.Draw:addParam("AA", "평타사거리표시", SCRIPT_PARAM_ONOFF, true)
    Menu.Draw:addParam("Q", "인광탄(Q)거리표시", SCRIPT_PARAM_ONOFF, true)
    Menu.Draw:addParam("R", "미사일폭격(R)거리표시", SCRIPT_PARAM_ONOFF, false)
     if Ignite ~= nil then
      Menu.Draw:addParam("Blank", "", SCRIPT_PARAM_INFO, "")
